...
PATH_ARMNMSH = '/fs/cetus/fs3/mrb/armn/armnmsh/mrb2/armnmsh'
PATH_RARC_MISSING = '/fs/cetus3/fs2/cmd/e/afsg/dap/cetus3/sa_mesh_forcing/rarc'
PATH_ARMNMSH = '/fs/cetus3/fs2/cmd/e/afsg/dap/RDRS_CaPA24h_prelim/fst'
PATH_RARC_MISSING = ''
...
def utctimetofstfname_capa(utctime):
        ...
        if (utctime.hour < 6):
                filetime = utctime + dt.relativedelta(hour = 0)
                filefcst = 6
...
def r2ctimeseriesfromfst(
	...
	if (not PROCESS_FSTCONVFLD):
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_temperature.r2c', framefreq = 60, fstnomvar = 'TT', AttributeName = 'Air_temperature_at_40m', AttributeUnits = 'K', intpopt = rmn.EZ_INTERP_LINEAR, constadd = 273.16))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_humidity.r2c', framefreq = 60, fstnomvar = 'HU', AttributeName = 'Specific_humidity_40m', AttributeUnits = 'kg kg**-1', intpopt = rmn.EZ_INTERP_LINEAR))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_pres.r2c', framefreq = 60, fstnomvar = 'P0', AttributeName = 'Air_pressure_at_surface', AttributeUnits = 'Pa', intpopt = rmn.EZ_INTERP_LINEAR, constmul = 100.0))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_longwave.r2c', framefreq = 60, fstnomvar = 'FI', AttributeName = 'Incoming_longwave_down_incident_at_surface', AttributeUnits = 'W m**-2', intpopt = rmn.EZ_INTERP_LINEAR))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_shortwave.r2c', framefreq = 60, fstnomvar = 'FB', AttributeName = 'Incoming_shortwave_down_incident_at_surface', AttributeUnits = 'W m**-2', intpopt = rmn.EZ_INTERP_LINEAR))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_wind.r2c', framefreq = 60, fstnomvar = 'UV', AttributeName = 'Wind_speed_at_40m', AttributeUnits = 'm s**-1', intpopt = rmn.EZ_INTERP_LINEAR, constmul = 0.5144444444444444444))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_winddir.r2c', framefreq = 60, fstnomvar = 'WD', AttributeName = 'Wind_direction_at_40m', AttributeUnits = 'degrees', intpopt = rmn.EZ_INTERP_LINEAR))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_wind_u-component.r2c', framefreq = 60, fstnomvar = 'UU', AttributeName = 'Wind_speed_U-component_at_40m', AttributeUnits = 'm s**-1', intpopt = rmn.EZ_INTERP_LINEAR, constmul = 0.5144444444444444444))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_wind_v-component.r2c', framefreq = 60, fstnomvar = 'VV', AttributeName = 'Wind_spped_V-component_at_40m', AttributeUnits = 'm s**-1', intpopt = rmn.EZ_INTERP_LINEAR, constmul = 0.5144444444444444444))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_rainacc.r2c', framefreq = 60, fstnomvar = 'PR0', AttributeName = 'Total_precipitation_accumulated_at_surface', AttributeUnits = 'kg m**-2', constmul = 1000.0))
		PROCESS_FSTCONVFLD.append(r2cconversionfieldfromfst(fpathr2cout = 'basin_rain.r2c', framefreq = 60, fstnomvar = 'PR0', AttributeName = 'Total_precipitation_rate_at_surface', AttributeUnits = 'kg m**-2 s**-1', constmul = 0.2777777777777778))
	...
	while FST_CURRENT_TIME < FST_STOP_BEFORE_TIME:
                ...
                fstsrc = utctimetofstfname_rdrs(FST_CURRENT_TIME)
